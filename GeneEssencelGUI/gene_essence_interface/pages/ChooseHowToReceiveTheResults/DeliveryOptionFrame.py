...
class _DeliveryCard(RoundedCard):
    """A card that selects a delivery option and expands to show its input."""
    ...
    def _update_display(self, *args):
        ...
        self.dot.delete('all')
        dot_color = COLORS['primary'] if selected else '#CBD5E1'
        self.dot.create_oval(1, 1, 15, 15, outline=dot_color, width=2)
        if selected:
...
class DeliveryOptionFrame(Frame):
